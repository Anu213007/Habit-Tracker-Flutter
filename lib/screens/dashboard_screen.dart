...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _loadData() async {
    ...
    if (authProvider.user != null) {
      await Future.wait([
        habitProvider.loadHabits(authProvider.user!.id),
  ...
  Widget _buildHomeTab() {
    return Consumer3<AuthProvider, HabitProvider, QuoteProvider>(
      builder: (context, authProvider, habitProvider, quoteProvider, child) {
      ...
      children: [
        ...
        if (habitProvider.todaysHabits.isEmpty)
          ...
          ...habitProvider.todaysHabits.take(3).map((habit) => Padding(
            ...
            child: HabitCard(
              habit: habit,
              onToggle: () => habitProvider.toggleHabitCompletion(authProvider.user!.id, habit.id),
            ),
  ...
  Widget _buildQuotesTab() {
    return Consumer2<AuthProvider, QuoteProvider>(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              habitProvider.deleteHabit(authProvider.user!.id, habit.id);
              Navigator.pop(context);
            },
