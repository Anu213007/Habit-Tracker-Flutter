                    ...
                    children: [
                      ...
                      LayoutBuilder(
                        builder: (context, c) {
                          ...
                          final iconSize = availableWidth < 360 ? 22.0 : 28.0;
                          final spacing = availableWidth < 360 ? 24.0 : 40.0;
                          return Padding(
                            padding: EdgeInsets.only(bottom: isShort ? 8 : 0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.eco, color: AppTheme.sageGreen.withOpacity(0.3), size: iconSize)
                                    .animate(onPlay: (controller) => controller.repeat())
                                    .moveY(begin: 0, end: -10, duration: const Duration(seconds: 2)),
                                SizedBox(width: spacing),
                                Icon(Icons.star, color: AppTheme.softYellow.withOpacity(0.3), size: iconSize - 3)
                                    .animate(onPlay: (controller) => controller.repeat())
                                    .moveY(begin: 0, end: -8, duration: const Duration(seconds: 3)),
                                SizedBox(width: spacing),
                                Icon(Icons.favorite, color: AppTheme.gentlePink.withOpacity(0.3), size: iconSize)
                                    .animate(onPlay: (controller) => controller.repeat())
