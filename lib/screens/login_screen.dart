                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Flexible(
                                ...
                                children: [
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      ...
                                      // FIXED: Removed extra backslash from regex
                          ...
                          ).animate().fadeIn(delay: const Duration(milliseconds: 600)).scale(begin: const Offset(0.9, 0.9), end: const Offset(1.0, 1.0)),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Icon(Icons.eco, color: AppTheme.sageGreen.withOpacity(0.3), size: 30)
